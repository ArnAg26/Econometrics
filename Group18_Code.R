...
df_prev<-read.csv("C:/Users/ARNAV/Documents/R/EconData/data/group_18.csv")

df_agg_exp_data <- read.csv("C:/Users/ARNAV/Documents/R/EconData/Aggregate Expenditure.csv")
df_agg_exp_data$State <- apply(df_agg_exp_data["State"],2,tolower)
View(df_agg_exp_data)


df_cap_exp_data <- read.csv("C:/Users/ARNAV/Documents/R/EconData/Capital Expenditure.csv")
df_cap_exp_data$State <- apply(df_cap_exp_data["State"],2,tolower)
View(df_cap_exp_data)


df_election_margin <- read.csv("C:/Users/ARNAV/Documents/R/EconData/Margin Of Election Victory - Sheet3.csv")
...
df_new_gini <- read.csv("C:/Users/ARNAV/Documents/R/EconData/Gini_New.csv")
...
#model_2 <- lm(GWL~SDP + SDP_2 + SDP_3 + electionMargin*gini + capital_exp+agg_exp + gini)

#model_2 <- lm(GWL~SDP + SDP_2 + SDP_3 + electionMargin + capital_exp*agg_exp+agg_exp + gini)

#model_2 <- lm(GWL~SDP + SDP_2 + SDP_3 + electionMargin + capital_exp+agg_exp + gini*SDP)
...
write.csv(df_q2_data,"C:/Users/ARNAV/Documents/R/EconData/Group18_final.csv")
